...
<div class="card card-danger card-outline">
    ...
    <form action="{{ route('update_subcostcenter', $subcentro[0]->id) }}" method="POST" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        ...
        <div class="card-body">
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="txtcentro" id="txtcentro" class="form-control">
                            <optgroup label="Selección Actual">
                                <option data-select2-id="#" value="{{$subcentro[0]->id_costo}}">
                                    {{$subcentro[0]->descripcioncecos}}
                                </option>
                            </optgroup>
                ...
                <div class="col-sm-7">
                    <div class="form-group">
                        ...
                        <input type="text" name="txtsubcentro" class="form-control" id="txtsubcentro" value="{{$subcentro[0]->subcentrocosto}}" placeholder="Ingresa un valor">
                    </div>
            ...
            <div class="card-boody">
                ...
                <a href="{{ route('list_subcostcenter') }}" class="btn btn-danger">
